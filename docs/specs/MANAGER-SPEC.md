...
- **ADR 003:** Gum UI Framework - Why gum for F11 Manager (internal decisions log)
- **ADR 005:** No External Scripts - Exception for F11 (interactive UI allowed) (internal decisions log)

## Implementation Status

- [x] **v0.1** - Prototype in `src/mission-control.sh` (monolithic)
- [ ] **v0.2** - Refactored in `src/ui/manager/` (UI components refactor)
